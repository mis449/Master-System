    ...
    <div className="bg-teal-50/40 p-5 rounded-2xl border border-teal-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        <div className="space-y-1.5">
          ...
          <input type="text" value={basicInfo.address} onChange={(e) => setBasicInfo({...basicInfo, address: e.target.value})} className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none" placeholder="Billing Address" />
        </div>
        <div className="space-y-1.5">
          <label className="block text-[11px] text-slate-700 font-medium uppercase tracking-wider">Area / PIN Code<span className="text-rose-500">*</span></label>
          <input type="text" value={basicInfo.areaPinCode || ''} onChange={(e) => setBasicInfo({...basicInfo, areaPinCode: e.target.value})} className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none" required />
        </div>
        <div className="space-y-1.5">
          <label className="block text-[11px] text-slate-700 font-medium uppercase tracking-wider">State</label>
          <input type="text" value={basicInfo.state || ''} onChange={(e) => setBasicInfo({...basicInfo, state: e.target.value})} className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none" placeholder="State" />
        </div>
        <div className="space-y-1.5">
          <label className="block text-[11px] text-slate-700 font-medium uppercase tracking-wider">Email</label>
          <input type="email" value={basicInfo.email || ''} onChange={(e) => setBasicInfo({...basicInfo, email: e.target.value})} className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none" />
        </div>
        <div className="space-y-1.5">
          <label className="block text-[11px] text-slate-700 font-medium uppercase tracking-wider">Mobile<span className="text-rose-500">*</span></label>
          <input type="tel" value={basicInfo.mobile || ''} onChange={(e) => setBasicInfo({...basicInfo, mobile: e.target.value})} className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none" required />
        </div>
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <input type="date" value={basicInfo.validityDate} onChange={(e) => setBasicInfo({...basicInfo, validityDate: e.target.value})} className="w-full pl-9 pr-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none" />
          </div>
        </div>
        <div className="space-y-1.5">
          <label className="block text-[11px] text-slate-700 font-medium uppercase tracking-wider">Price List</label>
          <select value={basicInfo.priceList} onChange={(e) => setBasicInfo({...basicInfo, priceList: e.target.value})} className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none">
        ...
        <div className="space-y-1.5">
          ...
          <select value={basicInfo.paymentTerms} onChange={(e) => setBasicInfo({...basicInfo, paymentTerms: e.target.value})} className="w-full px-3 py-1.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-4 focus:ring-teal-500/10 focus:border-teal-500 text-xs md:text-sm h-[38px] bg-white outline-none">

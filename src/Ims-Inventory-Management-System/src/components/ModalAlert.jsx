...
const ModalAlert = ({ 
  ...
  const config = {
    ...
    confirm: {
      icon: <HelpCircle className="text-sky-500" size={52} />,
          ...
          {type === 'confirm' ? (
            <>
              <button
                ...
                className={`flex-1 text-white font-bold py-4 rounded-2xl transition-all active:scale-95 shadow-lg shadow-sky-200/50 ${config.btnColor}`}
              >
                Confirm
              </button>
              <button

...
import { Search, Plus, RotateCcw, Filter, RefreshCw, Download, Edit, Eye, Trash2, FileText, ChevronLeft, ChevronRight } from 'lucide-react';
...
export default function InvoiceList({ conversionContext, clearConversionContext, onCreateSalesReturn }) {
  ...
  const handleExportPdf = () => {
    exportToPDF(getExportData(), exportHeaders, 'Invoices', 'invoices');
    toast.success('Exported to PDF successfully!');
  };

  const handleExportExcel = () => {
    exportToExcel(getExportData(), exportHeaders, 'invoices');

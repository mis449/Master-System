...
export default function AdminLayout({ children, darkMode, toggleDarkMode, showLayout = true }) {
  ...
  return (
    ...
    >
      {/* Sidebar for desktop */}
      <aside className="hidden w-48 flex-shrink-0 border-r border-blue-200 bg-white md:flex md:flex-col">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-[100] md:hidden">
          ...
          ></div>
          <div className="fixed inset-y-0 left-0 w-48 bg-white shadow-lg">
            <div className="flex h-14 items-center border-b border-blue-200 px-4 bg-gradient-to-r from-blue-100 to-purple-100">
              <Link
                to="/dashboard/admin"
                className="flex items-center gap-2 font-semibold text-blue-700"

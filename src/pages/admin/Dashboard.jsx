...
import UserStatusView from "./dashboard/views/UserStatusView.jsx"
...
export default function AdminDashboard() {
  ...
  const [dashboardType, setDashboardType] = useState(() => {
    if (viewParam === 'checklist') return 'checklist'
    if (viewParam === 'user_status') return 'user_status'
    return "user_status" // Default to user_status
  })

  // Sync dashboardType with viewParam if it changes
  useEffect(() => {
    if (viewParam === 'checklist') setDashboardType('checklist')
    else if (viewParam === 'user_status') setDashboardType('user_status')
  }, [viewParam])
